...
class NowPlayingFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        /**
         * 액티비티가 재실행 될 때마다 requestApplyInsets의 호출,
         * 혹은 기타 다른 이유로 이 리스너는 언제든지 호출될 수 있어서 하단 패딩이 계속 추가될 수 있기에
         * 초기값을 저장할 필요가 있다.
          */
        val initialPadding = playerView.paddingBottom
        playerView.setOnApplyWindowInsetsListener { view, windowInsets ->
            view.updatePadding(bottom = windowInsets.systemWindowInsetBottom + initialPadding)
            windowInsets
        }
